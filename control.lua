...
researchLookup["rampant-maintenance-reduce-failure"] = "failure"
researchLookup["rampant-maintenance-reduce-damage"] = "damage"
researchLookup["rampant-maintenance-reduce-damage-failure"] = "damage-failure"
researchLookup["rampant-maintenance-reduce-downtime"] = "downtime"
...
local function onResearchFinished(event)
    ...
    if (researchType) then
        ...
        researches[researchType] = currentResearch + (research.level * 0.05)
    end    
end

...
local function onModSettingsChange(event)
    ...
    world.buildDowntime["lamp"] = { settings.global["rampant-maintenance-lamp-min-downtime"].value*60, settings.global["rampant-maintenance-lamp-max-downtime"].value*60-settings.global["rampant-maintenance-lamp-min-downtime"].value*60 }
    ...
    world.buildDowntime["solar-panel"] = { settings.global["rampant-maintenance-solar-panel-min-downtime"].value*60, settings.global["rampant-maintenance-solar-panel-max-downtime"].value*60-settings.global["rampant-maintenance-solar-panel-min-downtime"].value*60 }
    ...
    world.buildDowntime["accumulator"] = { settings.global["rampant-maintenance-accumulator-min-downtime"].value*60, settings.global["rampant-maintenance-accumulator-max-downtime"].value*60-settings.global["rampant-maintenance-accumulator-min-downtime"].value*60 }
    ...
    world.buildDowntime["electric-pole"] = { settings.global["rampant-maintenance-electric-pole-min-downtime"].value*60, settings.global["rampant-maintenance-electric-pole-max-downtime"].value*60-settings.global["rampant-maintenance-electric-pole-min-downtime"].value*60 }
...
local function onResearchFinished(event)
    ...
    if (researchType) then
        ...
        researches[researchType] = (research.level * 0.09)
    end
end
